...
pub const cards = [_]CardEntry{
    ...
    .{ .id = "shard-bloom", .mod = .{ .damage_mul = 0.54, .fire_rate_mul = 0.82, .spread_radians_add = 0.6632251157578452, .proj_count_add = 5.0, .proj_size_mul = 0.78, .proj_range_px_set = 390.0 } },
    ...
    .{ .id = "radiant-overload", .mod = .{ .damage_mul = 1.24, .fire_rate_mul = 0.82, .proj_size_mul = 1.14, .proj_element = 6, .proj_impact_radius_set = 58.0 } },
    .{ .id = "rapid-refraction", .mod = .{ .fire_rate_mul = 1.22 } },
    .{ .id = "needle-compressor", .mod = .{ .fire_rate_mul = 1.14, .proj_size_mul = 0.86 } },
    .{ .id = "heavy-coolant", .mod = .{ .fire_rate_mul = 0.88, .proj_size_mul = 1.22 } },
    .{ .id = "essence-battery", .mod = .{} },
    .{ .id = "crystal-plating", .mod = .{ .max_health_add = 20.0, .move_speed_mul = 0.98 } },
    .{ .id = "phase-soles", .mod = .{ .move_speed_mul = 1.1 } },
    .{ .id = "wide-parry", .mod = .{ .parry_cover_mul = 1.28 } },
    .{ .id = "quick-parry", .mod = .{ .parry_cooldown_mul = 0.86 } },
    ...
    .{ .id = "sticky-ray", .mod = .{ .fire_rate_mul = 0.78, .proj_element = 0, .proj_impact = 2, .proj_impact_radius_set = 74.0 } },
    ...
    .{ .id = "bulwark-core", .mod = .{ .shield_charge_mul = 1.6 } },
