...
pub const cards = [_]CardEntry{
    ...
    .{ .id = "shard-bloom", .mod = .{ .damage_mul = 0.62, .fire_rate_mul = 0.82, .spread_radians_add = 0.6632251157578452, .proj_count_add = 5.0, .proj_size_mul = 0.78, .proj_range_px_set = 390.0 } },
