...
export const crystalRoundsCards: CardDefinition[] = [
  ...
  },
  {
    ...
    buckets: ["utility"],
    essenceCost: 4,
    description: "Shots your shield blocks bounce straight back at whoever fired them.",
    flavorText: "No, you.",
    modifier: {
      mirrorShield: true,
  ...
  // ── Movement augments (ride the wall kit) ────────────────────────────────
  {
    ...
    buckets: ["utility"],
    essenceCost: 3,
    description: "Move noticeably faster on the ground and through the air.",
  ...
  },
  {
    ...
    buckets: ["utility"],
    essenceCost: 3,
    description: "Lower gravity — floatier jumps and longer hang time for wall play.",
    flavorText: "Falling, but make it a decision.",
  ...
  },
  {
    ...
    buckets: ["utility"],
    essenceCost: 2,
    description: "Heavier + faster: you fall like a hammer and run a touch quicker. Wall-jumps hit sooner.",
    flavorText: "Down is a place you arrive at promptly.",
  ...
  },
  {
    ...
    buckets: ["utility"],
    essenceCost: 3,
    description: "Jump and wall-jump noticeably higher.",
    flavorText: "The ground pushes back harder.",
  ...
  },
  {
    ...
    buckets: ["utility"],
    essenceCost: 3,
    description: "Cling to walls: your wall-slide is far slower and stickier.",
  ...
  },
  {
    ...
    buckets: ["utility"],
    essenceCost: 4,
    description: "Grants a mid-air jump. Stacks for a triple, quadruple, …",
    flavorText: "Who said you only get one?",
  ...
  },
  {
    ...
    buckets: ["utility"],
    essenceCost: 4,
    description: "Unlocks DASH (press C): a fast horizontal burst. Grants one air-dash before landing.",
    flavorText: "Be elsewhere, immediately.",
  ...
  // ── Shield augments ──────────────────────────────────────────────────────
  {
    ...
    buckets: ["utility"],
    essenceCost: 3,
    description: "Much larger shield reserve — hold the block far longer before it pops.",
  ...
  },
  {
    ...
    buckets: ["utility"],
    essenceCost: 3,
    description: "Your shield recharges far faster between blocks.",
    flavorText: "Back up before they reload.",
  ...
  // ── Directional (aim) shield augments ────────────────────────────────────
  {
    ...
    buckets: ["utility"],
    essenceCost: 4,
    description: "Your shield only blocks where you AIM — but the frontal wall is huge. Cover your own flanks.",
    flavorText: "Point the no. Mean the no.",
  ...
  },
  {
    ...
    buckets: ["utility"],
    essenceCost: 6,
    description: "Aimed reflect wall: face a threat and its shots bounce straight back — with a big charge reserve.",
    flavorText: "Return to sender, at velocity.",
    modifier: {
