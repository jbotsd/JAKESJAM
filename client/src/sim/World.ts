...
export function stepWithRuntime(
  ...
  //    cooldown expires (only during fighting phase). Despawn entries whose
  //    owner has died this tick already (e.g. weapon recoil into a hazard).
  ...
  // 3. Projectiles: motion + collision against platforms and players.
